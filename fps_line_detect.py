...
class LineFollowerROS2(Node):
    def __init__(self, video_source=0):
        ...
        self.last_time = time.time()  # thời gian frame trước đó

        # Timer gọi hàm xử lý frame ~10 Hz (100 ms)
    ...
    def timer_callback(self):
        ...
        self.get_logger().info(f"State: {self.state} | v: {twist.linear.x:.2f}, w: {twist.angular.z:.2f} | FPS: {fps:.2f}")
